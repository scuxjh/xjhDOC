...
--
-- Dumping data for table `ko_persons`
--

LOCK TABLES `ko_persons` WRITE;
/*!40000 ALTER TABLE `ko_persons` DISABLE KEYS */;
INSERT INTO `ko_persons` VALUES (1,0,NULL,NULL,'MALE',NULL,NULL,'admin');
/*!40000 ALTER TABLE `ko_persons` ENABLE KEYS */;
UNLOCK TABLES;
...
-- Dump completed on 2017-07-12 19:27:11
