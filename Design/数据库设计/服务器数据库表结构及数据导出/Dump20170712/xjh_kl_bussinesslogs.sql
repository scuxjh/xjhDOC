...
--
-- Dumping data for table `kl_bussinesslogs`
--

LOCK TABLES `kl_bussinesslogs` WRITE;
/*!40000 ALTER TABLE `kl_bussinesslogs` DISABLE KEYS */;
/*!40000 ALTER TABLE `kl_bussinesslogs` ENABLE KEYS */;
UNLOCK TABLES;
