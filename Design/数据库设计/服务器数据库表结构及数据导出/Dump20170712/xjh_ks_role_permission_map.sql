...
--
-- Dumping data for table `ks_role_permission_map`
--

LOCK TABLES `ks_role_permission_map` WRITE;
/*!40000 ALTER TABLE `ks_role_permission_map` DISABLE KEYS */;
/*!40000 ALTER TABLE `ks_role_permission_map` ENABLE KEYS */;
UNLOCK TABLES;
...
-- Dump completed on 2017-07-12 19:26:53
